...
public class AtlasCachedTmxMapLoader extends
        BaseTmxMapLoader<AtlasCachedTmxMapLoader.AtlasTiledMapLoaderParameters> {
    ...
    public AtlasCachedTmxMapLoader(TextureAtlas atlas) {
        this(atlas, new InternalFileHandleResolver());
    }

    public AtlasCachedTmxMapLoader(TextureAtlas atlas, FileHandleResolver resolver) {
        super(resolver);
        this.atlas = atlas;
    }
    ...
    public TiledMap load(String fileName, AtlasTiledMapLoaderParameters parameter) {
        try {
            ...
            TiledMap map = loadMap(root, tmxFile);
    ...
    protected TiledMap loadMap(Element root, FileHandle tmxFile) {
                ...
                if (tile != null) {
                    ...
                    if (animationElement != null) {
                        ...
                        for (Element frameElement : animationElement.getChildrenByName("frame")) {
                            staticTiles.add((StaticTiledMapTile) tileset.getTile(firstgid
                                    + frameElement.getIntAttribute("tileid")));
                            intervals.add(frameElement.getIntAttribute("duration"));
                        }

                        AnimatedTiledMapTile animatedTile = new AnimatedTiledMapTile(intervals,
                                staticTiles);
