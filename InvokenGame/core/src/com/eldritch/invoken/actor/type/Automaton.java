...
public class Automaton extends Npc {
    ...
    private Automaton(NonPlayerActor data, Optional<ActorScenario> scenario, float x, float y,
    ...
    public static Automaton from(NonPlayerActor data, Optional<ActorScenario> scenario, float x,
            float y, Level level) {
        ...
        switch (base) {
            ...
            default:
                return new Mech(data, scenario, x, y, getAssetPath(asset), level);
        }
    }
    ...
    public static class Android extends Automaton {
        ...
        public Android(NonPlayerActor data, Optional<ActorScenario> scenario, float x, float y,
    ...
    public static class Mech extends Automaton {
        ...
        public Mech(NonPlayerActor data, Optional<ActorScenario> scenario, float x, float y,
                String asset, Level level) {
            this(data, scenario, x, y, Settings.SCALE * PX, Settings.SCALE * PX, PX, asset, level);
        }

        public Mech(NonPlayerActor data, Optional<ActorScenario> scenario, float x, float y,
                float width, float height, int px, String asset, Level level) {
            super(data, scenario, x, y, width, height, MAX_VELOCITY, getAnimations(asset, px),
                    level);
        }
    ...
    public static class Goliath extends Mech {
        ...
        public Goliath(NonPlayerActor data, Optional<ActorScenario> scenario, float x, float y,
                String asset, Level level) {
            super(data, scenario, x, y, Settings.SCALE * PX, Settings.SCALE * PX, PX, asset, level);
        }
    }
}
