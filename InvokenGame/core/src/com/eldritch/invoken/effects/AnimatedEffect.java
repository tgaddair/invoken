...
public abstract class AnimatedEffect extends BasicEffect {
    ...
    public AnimatedEffect(Agent actor, TextureRegion[] region, Vector2 offset) {
        this(actor, region, offset, Settings.SCALE * region[0].getRegionWidth(), Settings.SCALE
    ...
    public void render(float delta, OrthogonalTiledMapRenderer renderer) {
        ...
        batch.begin();
        batch.draw(frame, position.x - width / 2 - offset.x, position.y - height / 2 - offset.y, // position
