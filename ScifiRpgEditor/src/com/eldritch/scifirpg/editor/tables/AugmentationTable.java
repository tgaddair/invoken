...
public class AugmentationTable extends AssetTable<AugmentationProto> {
	...
	@Override
	protected JPanel getEditorPanel(Optional<AugmentationProto> prev,
			JFrame frame) {
	...
	private static class TraitEditorPanel extends
		...
		public TraitEditorPanel(AugmentationTable owner, JFrame frame,
			...
			comboBox.setModel(new DefaultComboBoxModel<AugmentationProto>(
					values.toArray(new AugmentationProto[0])));
